...
export function registerBucketTools(server: McpServer, client: VikunjaClientApi): void {
  ...
  server.registerTool(
    ...
    withToolLogging("bucket_create", async (args) => {
      try {
  ...
  server.registerTool(
    ...
    withToolLogging("bucket_update", async (args) => {
      try {
  ...
  server.registerTool(
    ...
    withToolLogging("bucket_delete", async ({ project_id, view_id, bucket_id, confirm }) => {
      try {
